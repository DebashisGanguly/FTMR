...
public class TaskReport implements Writable {
	...
	private long sortFinishedTime;
	private long shuffleFinishedTime;
	...
	TaskReport(TaskID taskid, float progress, String state,
			String[] diagnostics, long startTime, long sortFinishedTime, long shuffleFinishedTime, long finishTime,
			Counters counters, String trackerName) {
		this(taskid, progress, state, diagnostics, null, startTime, sortFinishedTime, shuffleFinishedTime, finishTime, counters, trackerName);
	}
	...
	TaskReport(TaskID taskid, float progress, String state,
			...
			long startTime, long sortFinishedTime, long shuffleFinishedTime, long finishTime,
			Counters counters, String trackerName) {
		this.taskid = taskid;
		...
		this.sortFinishedTime = sortFinishedTime;
		this.shuffleFinishedTime = shuffleFinishedTime;
	...
	/** The current status */
	public TIPStatus getCurrentStatus() {return currentStatus;}
	/** get TT where ran the task */
	public String getTrackerName() { return trackerName; }


	public long getSortFinishedTime() {
		return sortFinishedTime;
	}

	public long getShuffleFinishedTime() {
		return shuffleFinishedTime;
	}
	...
	throws IOException  {
		...
		out.writeLong(shuffleFinishedTime);
		out.writeLong(sortFinishedTime);
	...
	public void readFields(DataInput in) throws IOException {
		...
		this.shuffleFinishedTime = in.readLong();
		this.sortFinishedTime = in.readLong();
