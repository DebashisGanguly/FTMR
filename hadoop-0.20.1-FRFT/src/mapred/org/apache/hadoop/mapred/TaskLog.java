...
public class TaskLog {
	...
	private static LogFileDetail getTaskLogFileDetail(TaskAttemptID taskid, LogName filter)
	throws IOException 
	{
	...
	private static void writeToIndexFile(TaskAttemptID firstTaskid, boolean isCleanup) 
	throws IOException 
	{
	...
	public synchronized static void syncLogs(TaskAttemptID firstTaskid, TaskAttemptID taskid, boolean isCleanup) 
	throws IOException 
	{
		System.out.flush();
		System.err.flush();
	...
	public static List<String> captureOutAndError(List<String> cmd, 
		...
		return captureOutAndError(null, cmd, stdoutFilename, stderrFilename, tailLength, null );
	}
	...
	throws IOException 
	{
		return captureOutAndError(setup, cmd, stdoutFilename, stderrFilename, tailLength, null);
	}
