...
interface InterTrackerProtocol extends VersionedProtocol {
	...
	//   * @throws IOException
	//   */
	//  void reportReduceTaskDone(TaskAttemptID taskid) throws IOException;
	 ...
	 * @throws IOException
	 */
//	boolean forceKillTask(TaskAttemptID taskId) throws IOException;

	/**
	 * Request a specific task to execute
	 * @param jobid
	 * @param taskid
	 * @return
	 * @throws IOException
	 */
	void requestMap(JobID jobid, TaskAttemptID taskid) throws IOException;
