...
public abstract class FileOutputFormat<K, V> implements OutputFormat<K, V> {
    ...
    public void checkOutputSpecs(FileSystem ignored, JobConf job) 
        ...
        if (outDir != null) {
            ...
            setOutputDigestsPath(job, outDir);
            // check its existence
            if (fs.exists(outDir)) {
    ...
    public static void setOutputPath(JobConf conf, Path outputDir) {
        ...
        setOutputDigestsPath(conf, outputDir);
    }

    public static void setOutputDigestsPath(JobConf conf, Path outputDir) {
        outputDir = new Path(conf.getWorkingDirectory(), outputDir);
        conf.set("mapred.output.digests.dir", outputDir.toString() + "/" + SHA_DIR_NAME);
    }
    ...
    public static Path getWorkOutputPath(JobConf conf) {
        ...
        Path res = new Path(name);
        Log.debug("getWorkOutputPath: " + res.toUri());
    ...
    public static Path getTaskOutputPath(JobConf conf, String name) 
        ...
        Path res = new Path(workPath, name);
