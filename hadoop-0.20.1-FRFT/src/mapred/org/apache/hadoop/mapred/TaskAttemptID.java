 ...
 * <code>attempt_200707121733_0003_m_000005_0_0_0</code> , which represents the
...
public class TaskAttemptID extends org.apache.hadoop.mapreduce.TaskAttemptID {
	 ...
	 */
	public TaskAttemptID(String jtIdentifier, int jobId, boolean isMap, int taskId, int numReplica, int id) {
		this(new TaskID(jtIdentifier, jobId, isMap, taskId, numReplica), id);
	}
	 ...
	 * </pre>
	 * which will return :
	 * <pre> "attempt_[^_]*_[0-9]*_m_000001_nrR_purpose_[0-9]*" </pre> 
	 * @param jtIdentifier jobTracker identifier, or null
	 * @param jobId job number, or null
	 * @param isMap whether the tip is a map, or null 
	 * @param taskId taskId number, or null
	 * @param splitNr number of the split
	...
	public static String getTaskAttemptIDsPattern(String jtIdentifier,
			Integer jobId, Boolean isMap, Integer taskId, Integer num_replica, Integer attemptId) 
	{
		StringBuilder builder = new StringBuilder(ATTEMPT).append(SEPARATOR);
		builder.append(getTaskAttemptIDsPatternWOPrefix(jtIdentifier, jobId, isMap, taskId, num_replica, attemptId));
			...
			Integer jobId, Boolean isMap, Integer taskId, Integer num_replica, Integer attemptId) 
	{
		...
		builder.append(TaskID.getTaskIDsPatternWOPrefix(jtIdentifier, jobId, isMap, taskId, num_replica))
		.append(SEPARATOR)
