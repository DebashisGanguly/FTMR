...
/**
 * This child corresponds to the child that TaskTracker launches.
 */
 ...
 * This child process runs map and reduce tasks launched by the TaskTracker
 */
class Child {
	...
	public static void main(String[] args) throws Throwable {
		...
		LOG.debug("JVMId " + jvmId.getId() + " to < " + firstTaskid.getJobID() + ", " + firstTaskid + " >");
		...
		// To track logs of the current task
		Thread t = new Thread() {
			public void run() {
		...
		try {
			while (true) {
				...
				LOG.info("Child starting (" + taskid + ")");
