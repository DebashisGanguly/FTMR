...
public class TaskLogServlet extends HttpServlet {
	...
	{
		return ("http://" + taskTrackerHostName + ":" + httpPort + "/tasklog?taskid=" + taskAttemptID);
	}
	...
	/**
	 * Print the log files of an attempt in JSP page.
	 * @param response
	 * @param out
	 * @param taskId
	 * @param start
		...
		try {
			...
			if (filter == TaskLog.LogName.DEBUGOUT) {
				...
				response.sendError(HttpServletResponse.SC_GONE,
						"Failed to retrieve " + filter + " log for task: " + taskId);
	 ...
	 * Eg.: http://virtuakarmic:50060/tasklog?plaintext=true&taskid=attempt_201003092151_0003_r_000000_1153490528_3000_0&filter=stdout
	 */
	@Override
	...
	throws ServletException, IOException 
	{
		...
		// taskIdStr = attempt_201002201155_0001_m_000004_0_0_0
