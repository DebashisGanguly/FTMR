...
public class RandomTextWriter extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		// /opt/hadoop/bin/hadoop jar /opt/hadoop/hadoop-0.20.2-dev-examples.jar randomtextwriter -D test.randomtextwrite.total_bytes=214748 -D test.randomtextwrite.bytes_per_map=214748/100 -D test.randomtextwrite.min_words_key=5 -D test.randomtextwrite.max_words_key=10 -D test.randomtextwrite.min_words_value=100 -D test.randomtextwrite.max_words_value=10000 -D mapred.output.compress=true -D mapred.map.output.compression.type=BLOCK -outFormat org.apache.hadoop.mapred.SequenceFileOutputFormat /gridmix/data/WebSimulationBlockCompressed
		//	  bin/hadoop jar build/hadoop-0.20.2-dev-examples.jar randomtextwriter -D test.randomtextwrite.total_bytes=214748 -D test.randomtextwrite.bytes_per_map=214748 -D test.randomtextwrite.min_words_key=5 -D test.randomtextwrite.max_words_key=10 -D test.randomtextwrite.min_words_value=100 -D test.randomtextwrite.max_words_value=10000 -D mapred.output.compress=true -D mapred.map.output.compression.type=BLOCK -outFormat org.apache.hadoop.mapred.SequenceFileOutputFormat /gridmix/data/WebSimulationBlockCompressed
