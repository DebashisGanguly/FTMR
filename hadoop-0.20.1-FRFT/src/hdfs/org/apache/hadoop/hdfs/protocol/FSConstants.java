...
public interface FSConstants {
  ...
  int BLOCK_INVALIDATE_CHUNK = 100;
  ...
  long DEFAULT_BLOCK_SIZE = 64 * 1024 * 1024;
  int DEFAULT_DATA_SOCKET_SIZE = 128 * 1024;

  int SIZE_OF_INTEGER = Integer.SIZE / Byte.SIZE;

  // SafeMode actions
  enum SafeModeAction{ SAFEMODE_LEAVE, SAFEMODE_ENTER, SAFEMODE_GET
  }

  // type of the datanode report
  enum DatanodeReportType {ALL, LIVE, DEAD }
